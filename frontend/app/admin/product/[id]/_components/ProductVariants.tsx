        ...
        <Card className='border-0 shadow-none gap-0 mb-0! bg-transparent'>
            <CardHeader className='flex flex-row items-center justify-between gap-4'>
                ...
                <Button
                    type="button"
                    size="sm"
                    onClick={() => append({ sku: "", size: "M", price_override: 0, offer_price_override: 0, stock_quantity: 0 })}
                >
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                ...
                                                                <FormControl>
                                                                    <Input type='number' placeholder="Price Override" {...field} value={field.value as string | number} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : 0)} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                ...
                                                                <FormControl>
                                                                    <Input type='number' placeholder="Offer Price Override" {...field} value={field.value as string | number} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : 0)} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                        ...
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    ...
                                                                    <FormControl>
                                                                        <Input type='number' placeholder="Stock Quantity" {...field} value={field.value as string | number} onChange={e => field.onChange(e.target.value ? Number(e.target.value) : 0)} />
                                                                    </FormControl>
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
